...
export default {
  ...
  props: Object.assign({}, T.props, {
    ...
    // fixed: ant-design-vue 1.5.0版本以上出现排列问题 @evanxu
    tableLayout: {
      type: String,
      default: 'fixed',
    },
  ...
  watch: {
    ...
    // fixed:当页面使用同一模板情况下 站点变化时触发
    data(newVal, oldVal) {
      // console.log('stable', newVal, oldVal);
      // 判断接口是否一致
      if (newVal !== oldVal) {
        // 不一致，重新加载最新数据
        // console.log('stableR');
      ...
      const parameter = Object.assign(
        {
          ...
          limit:
            (pagination && pagination.pageSize) || this.localPagination.pageSize || this.pageSize,
        },
        (sorter &&
          sorter.field && {
      ...
      if (
        ...
        result.then((r) => {
          this.localPagination = Object.assign({}, this.localPagination, {
            current: r.data.page, // 返回结果中的当前分页数
          ...
          if (r.data.list.length === 0 && this.localPagination.current > 1) {
          ...
          (!this.showPagination || (!r.totalCount && this.showPagination === 'auto')) &&
